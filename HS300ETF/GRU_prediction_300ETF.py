...
if __name__ == "__main__":
    ...
    regressor = build_GRU_model(indicators, timesteps, X_train1, y_train1,
                                 units=256, dropout_rate=0.3, epochs=50, batch_size=32)
    ...
    #当前数据集最优参数: {'batch_size': 32, 'dropout_rate': 0.3, 'epochs': 50, 'optimizer': 'adam', 'units': 256}
    ...
    file_path1 = os.path.join(r'E:\Option_data\沪深300ETF\300ETF实证选择数据\LSTM_(20231227, 3.6, 20160)',
                              f"(20231227, 3.6, 20160)_GRU直接预测测试集.csv")
    dataset_test.to_csv(file_path1, index=False)
    # 保存模型
    model_path = r'E:\Option_data\沪深300ETF\300ETF实证选择数据\LSTM_(20231227, 3.6, 20160)\gru_price_model.h5'
