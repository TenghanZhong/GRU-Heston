...
if __name__ == '__main__':
    ...
    data1 = pd.read_csv(r'E:\Option_data\沪深300ETF\300ETF看涨期权(1).csv')
    data2 = pd.read_csv(r'E:\Option_data\沪深300ETF\300ETF看涨期权(2).csv')
    data3 = pd.read_csv(r'E:\Option_data\沪深300ETF\300ETF看跌期权(1).csv')
    data4 = pd.read_csv(r'E:\Option_data\沪深300ETF\300ETF看跌期权(2).csv')
    ...
    vol_plot(data_put)
    #保存文件
    file_path1 = os.path.join('E:\Option_data\沪深300ETF', f"300ETF_看涨期权_iv.csv")
    file_path2 = os.path.join('E:\Option_data\沪深300ETF', f"300ETF_看跌期权_iv.csv")
    data_call.to_csv(file_path1, index=False)
    data_put.to_csv(file_path2, index=False)
