...
if __name__ == "__main__":
    data_lstm=pd.read_csv(r'E:\Option_data\上证50ETF\实证选择数据\LSTM_(20231227,2.608,20160)\(20231227,2.608,20160)_测试集_LSTM训练后.csv')
    data_gru=pd.read_csv(r'E:\Option_data\上证50ETF\实证选择数据\LSTM_(20231227,2.608,20160)\(20231227,2.608,20160)_测试集_GRU训练后.csv')
    data_bs=pd.read_csv(r'E:\Option_data\上证50ETF\实证选择数据\LSTM_(20231227,2.608,20160)\(20231227,2.608,20160)_测试集_bsm.csv')
    lstm_price=pd.read_csv(r'E:\Option_data\上证50ETF\实证选择数据\LSTM_(20231227,2.608,20160)\(20231227,2.608,20160)_LSTM直接预测测试集.csv')
    gru_price = pd.read_csv(
        r'E:\Option_data\上证50ETF\实证选择数据\LSTM_(20231227,2.608,20160)\(20231227,2.608,20160)_GRU直接预测测试集.csv')
    ...
    #打印误差
    print(lstm_heston_error_summary)#Mean Square Error of LSTM-Heston Model (%) : 0.000008271
